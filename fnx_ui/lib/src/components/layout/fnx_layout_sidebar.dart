...
@Component(
  ...
  styles: const [
    ":host {display: block;}",
    "::ng-deep .layout__sidebar > *:only-child { position: absolute; top:0; left:0; bottom:0; right:0; }",
    "::ng-deep .layout__main > *:only-child { position: absolute; top:0; left:0; bottom:0; right:0; }"
  ],
