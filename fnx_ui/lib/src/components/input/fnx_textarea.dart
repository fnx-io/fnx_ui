...
const CUSTOM_INPUT_TEXTAREA_VALUE_ACCESSOR = const Provider(ngValueAccessor, useExisting: FnxTextarea);
...
''',
  ...
  providers: const [
    ...
    const Provider(Focusable, useExisting: FnxTextarea),
    const Provider(FnxValidatorComponent, useExisting: FnxTextarea),
  ],
