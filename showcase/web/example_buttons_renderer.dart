...
@Component(
  ...
  <p class="margin--bottom padding--bottom border--bottom">
    ...
    <a target="_blank" href="https://github.com/fnx-io/fnx_ui/blob/master/example/{{name}}.dart" class="btn">Dart <span class="hide-on-s hide-on-m">source</span></a>
    <a target="_blank" href="https://github.com/fnx-io/fnx_ui/blob/master/example/{{name}}.html" class="btn">Template <span class="hide-on-s hide-on-m">source</span></a>
  </p>
'''
)
